...
function buildVolumeMounts(
  ...
  // Mount agent-runner source read-only. The container compiles it to /tmp/dist
  // (ephemeral, per-run) so agents cannot persist changes to runner code between runs.
